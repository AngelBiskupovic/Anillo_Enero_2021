...
while True:
    ...
    # Reading Inputs
    flocculant = read_float(0,1)
    output_flow = read_float(2,1)
    ...
    write_float(4, [input_flow,input_solidC])
    ...
    write_float(8, [output[0],output[1],output[2],output[3]])
